...
module.exports = async function (deployer) {
    const assetsExchangeInstance = await deployProxy(
        AssetsExchange,
        [
            pangolinRouter,
            supportedAssets
    ...
    console.log(`Deployed PangolinExchange (TransparentUpgradeableProxy). Proxy address: ${assetsExchangeInstance.address}`);
