...
interface ISmartLoanLiquidationFacet {
  ...
  function liquidateLoan ( bytes32[] memory assetsToRepay, uint256[] memory amountsToRepay, uint256 _liquidationBonus, uint256 _feesLiquidationBonusPercent) external;
  function unsafeLiquidateLoan ( bytes32[] memory assetsToRepay, uint256[] memory amountsToRepay, uint256 _liquidationBonus, uint256 _feesLiquidationBonusPercent) external;
