...
export default {
    ...
    GMX_V2_ASSETS_CONFIG: {
        "GM_AVAX_WAVAX": {minSPrimeToUnlock: 1, isGMXPlus: true, aprWarning: true, name: "AVAX+", symbol: "GM_AVAX_WAVAX", short: "GM", decimals: 18, address: addresses.GM_AVAX_WAVAX, debtCoverage: 0.83333333333, longToken: 'AVAX', shortToken: 'AVAX', indexTokenAddress: addresses.AVAX, link: 'https://app.gmx.io/#/stats', addMethod: 'depositAvaxGmxV2Plus', removeMethod: 'withdrawAvaxGmxV2Plus', apy: 22.55},
        "GM_BTC_BTCb": {minSPrimeToUnlock: 1, isGMXPlus: true, aprWarning: true, name: "BTC+", symbol: "GM_BTC_BTCb", logoExt: "png", short: "GM", decimals: 18, address: addresses.GM_BTC_BTCb, debtCoverage: 0.83333333333, longToken: 'BTC', shortToken: 'BTC', indexTokenAddress: addresses.BTC, link: 'https://app.gmx.io/#/stats', addMethod: 'depositBtcGmxV2Plus', removeMethod: 'withdrawBtcGmxV2Plus', apy: 13.4},
        "GM_ETH_WETHe": {minSPrimeToUnlock: 1, isGMXPlus: true, aprWarning: true, name: "ETH+", symbol: "GM_ETH_WETHe", short: "GM", decimals: 18, address: addresses.GM_ETH_WETHe, debtCoverage: 0.83333333333, longToken: 'ETH', shortToken: 'ETH', indexTokenAddress: addresses.ETH, link: 'https://app.gmx.io/#/stats', addMethod: 'depositEthGmxV2Plus', removeMethod: 'withdrawEthGmxV2Plus', apy: 11.43},
