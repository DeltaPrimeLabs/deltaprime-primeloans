...
export default {
  ...
  ASSETS_CONFIG: {
    ...
    'GLP': {
      ...
      logoExt: 'png',
      decimals: 18,
      address: addresses.GLP,
      debtCoverage: 0.83333333333,
      swappableAssets: ['BTC', 'ETH', 'USDC']
    },
    'sAVAX': {
      name: 'sAVAX',
      symbol: 'sAVAX',
  ...
  LP_ASSETS_CONFIG: {
    'PNG_AVAX_USDC_LP': {
      ...
      decimals: 18,
      address: addresses.PNG_AVAX_USDC_LP,
      debtCoverage: 0.83333333333
    },
    'PNG_AVAX_USDT_LP': {
      primary: 'USDT',
      ...
      name: 'AVAX-USDT',
      dex: 'Pangolin',
      symbol: 'PNG_AVAX_USDT_LP',
      decimals: 18,
      address: addresses.PNG_AVAX_USDT_LP,
      debtCoverage: 0.83333333333
    },
    'PNG_AVAX_ETH_LP': {
      primary: 'ETH',
      ...
      name: 'AVAX-ETH',
      dex: 'Pangolin',
      symbol: 'PNG_AVAX_ETH_LP',
      decimals: 18,
      address: addresses.PNG_AVAX_ETH_LP,
      debtCoverage: 0.83333333333
    },
    'TJ_AVAX_USDC_LP': {
      primary: 'USDC',
      ...
      name: 'AVAX-USDC',
      dex: 'TraderJoe',
      addMethod: 'addLiquidityTraderJoe',
      removeMethod: 'removeLiquidityTraderJoe',
      symbol: 'TJ_AVAX_USDC_LP',
      decimals: 18,
      address: addresses.TJ_AVAX_USDC_LP,
      debtCoverage: 0.83333333333
    },
    'TJ_AVAX_USDT_LP': {
      primary: 'USDT',
      ...
      addMethod: 'addLiquidityTraderJoe',
      removeMethod: 'removeLiquidityTraderJoe',
      symbol: 'TJ_AVAX_USDT_LP',
      decimals: 18,
      address: addresses.TJ_AVAX_USDT_LP,
      debtCoverage: 0.83333333333
    },
    'TJ_AVAX_ETH_LP': {
      primary: 'ETH',
      ...
      addMethod: 'addLiquidityTraderJoe',
      removeMethod: 'removeLiquidityTraderJoe',
      symbol: 'TJ_AVAX_ETH_LP',
      decimals: 18,
      address: addresses.TJ_AVAX_ETH_LP,
      debtCoverage: 0.83333333333
    },
    'TJ_AVAX_BTC_LP': {
      primary: 'BTC',
      ...
      addMethod: 'addLiquidityTraderJoe',
      removeMethod: 'removeLiquidityTraderJoe',
      symbol: 'TJ_AVAX_BTC_LP',
      decimals: 18,
      address: addresses.TJ_AVAX_BTC_LP,
      debtCoverage: 0.83333333333
    },
    'TJ_AVAX_sAVAX_LP': {
      primary: 'sAVAX',
      ...
      addMethod: 'addLiquidityTraderJoe',
      removeMethod: 'removeLiquidityTraderJoe',
      symbol: 'TJ_AVAX_sAVAX_LP',
      decimals: 18,
      address: addresses.TJ_AVAX_sAVAX_LP,
      debtCoverage: 0.83333333333
    },
  },
  CONCENTRATED_LP_ASSETS_CONFIG: {
    'SHLB_AVAX-USDC_B': {
      ...
      name: 'AVAX-USDC',
      dex: 'SteakHut',
      symbol: 'SHLB_AVAX-USDC_B',
      addMethod: 'stakeSteakHutAVAXUSDC',
      removeMethod: 'unstakeSteakHutAVAXUSDC',
      decimals: 18,
      address: addresses['SHLB_AVAX-USDC_B'],
      tvl: 450000,
      debtCoverage: 0.83333333333
    },
    'SHLB_BTC.b-AVAX_B': {
      ...
      name: 'BTC.b-AVAX',
      dex: 'SteakHut',
      symbol: 'SHLB_BTC.b-AVAX_B',
      addMethod: 'stakeSteakHutBTCAVAX',
      removeMethod: 'unstakeSteakHutBTCAVAX',
      decimals: 18,
      address: addresses['SHLB_BTC.b-AVAX_B'],
      tvl: 320000,
      debtCoverage: 0.83333333333
    },
    'SHLB_USDT.e-USDt_C': {
      ...
      name: 'USDT.e-USDT',
      dex: 'SteakHut',
      symbol: 'SHLB_USDT.e-USDt_C',
      addMethod: 'stakeSteakHutUSDTeUSDT',
      removeMethod: 'unstakeSteakHutUSDTeUSDT',
      decimals: 18,
      address: addresses['SHLB_USDT.e-USDt_C'],
      tvl: 280000,
      debtCoverage: 0.83333333333
    },
  },
