...
export default {
    ...
    GMX_V2_ASSETS_CONFIG: {
        ...
        "GM_NEAR_WETH_USDC": {name: "NEAR-WETH", symbol: "GM_NEAR_WETH_USDC", short: "GM", logoExt: 'png', price: 1, decimals: 18, address: addresses.GM_NEAR_WETH_USDC, debtCoverage: 0.83333333333, iconToken: 'NEAR', longToken: 'ETH', shortToken: 'USDC', indexTokenAddress: "0x1FF7F3EFBb9481Cbd7db4F932cBCD4467144237C", link: 'https://app.gmx.io/#/stats'},
        "GM_ATOM_WETH_USDC": {name: "ATOM-WETH", symbol: "GM_ATOM_WETH_USDC", short: "GM", logoExt: 'svg', price: 1, decimals: 18, address: addresses.GM_ATOM_WETH_USDC, debtCoverage: 0.83333333333, iconToken: 'ATOM', longToken: 'ETH', shortToken: 'USDC', indexTokenAddress: "0x7D7F1765aCbaF847b9A1f7137FE8Ed4931FbfEbA", link: 'https://app.gmx.io/#/stats'},
