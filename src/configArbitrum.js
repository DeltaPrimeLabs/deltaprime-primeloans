...
export default {
    ...
    TRADERJOEV2_LP_ASSETS_CONFIG: {
        ...
        'TJLB_GRAIL_ETH': { primary: 'GRAIL', secondary: 'ETH', name: 'GRAIL-ETH', dex: 'TraderJoe', symbol: 'TJLB_GRAIL_ETH', decimals: 18, baseFee: '0.0025', address: addresses['TJLB_GRAIL_ETH'], binStep: 25, addMethod: 'addLiquidityTraderJoeV2', removeMethod: 'removeLiquidityTraderJoeV2', link: "https://traderjoexyz.com/arbitrum/pool/v21/0x3d9907f9a368ad0a51be60f7da3b97cf940982d8/ETH/25", rewardTokens: [{ symbol: 'ARB', address: addresses['ARB'], decimals: 18 }]},
        'TJLB_WOO_ETH': { primary: 'WOO', secondary: 'ETH', name: 'WOO-ETH', dex: 'TraderJoe', symbol: 'TJLB_WOO_ETH', decimals: 18, baseFee: '0.0025', address: addresses['TJLB_WOO_ETH'], binStep: 25, addMethod: 'addLiquidityTraderJoeV2', removeMethod: 'removeLiquidityTraderJoeV2', link: "https://traderjoexyz.com/arbitrum/pool/v21/0xcafcd85d8ca7ad1e1c6f82f651fa15e33aefd07b/ETH/25", rewardTokens: [{ symbol: 'WOO', address: addresses['WOO'], decimals: 18 }, { symbol: 'ARB', address: addresses['ARB'], decimals: 18 }]},
        'TJLB_JOE_ETH': { primary: 'JOE', secondary: 'ETH', name: 'JOE-ETH', dex: 'TraderJoe', symbol: 'TJLB_JOE_ETH', decimals: 18, baseFee: '0.002', address: addresses['TJLB_JOE_ETH'], binStep: 20, addMethod: 'addLiquidityTraderJoeV2', removeMethod: 'removeLiquidityTraderJoeV2', link: "https://traderjoexyz.com/arbitrum/pool/v21/0x371c7ec6d8039ff7933a2aa28eb827ffe1f52f07/ETH/20", rewardTokens: [{ symbol: 'JOE', address: addresses['JOE'], decimals: 18 }]},
        'TJLB_USDT_USDCe': { primary: 'USDT', secondary: 'USDC.e', name: 'USDT-USDCe', dex: 'TraderJoe', symbol: 'TJLB_USDT_USDCe', decimals: 18, baseFee: '0.00005', address: addresses['TJLB_USDT_USDCe'], binStep: 1, addMethod: 'addLiquidityTraderJoeV2', removeMethod: 'removeLiquidityTraderJoeV2', link: "https://traderjoexyz.com/arbitrum/pool/v21/0xfd086bc7cd5c481dcc9c85ebe478a1c0b69fcbb9/0xff970a61a04b1ca14834a43f5de4533ebddb5cc8/1", rewardTokens: [{ symbol: 'JOE', address: addresses['JOE'], decimals: 18 }]},
