...
export default {
    ...
    GMX_V2_ASSETS_CONFIG: {
        "GM_ETH_WETH": {isGMXPlus: true, name: "ETH+", symbol: "GM_ETH_WETH", short: "GM", decimals: 18, address: addresses.GM_ETH_WETH, debtCoverage: 0.83333333333, longToken: 'ETH', shortToken: 'ETH', indexTokenAddress: addresses.ETH, link: 'https://app.gmx.io/#/stats'},
        "GM_BTC_WBTC": {isGMXPlus: true, name: "BTC+", symbol: "GM_BTC_WBTC", short: "GM", logoExt: "png", decimals: 18, address: addresses.GM_BTC_WBTC, debtCoverage: 0.83333333333, longToken: 'BTC', shortToken: 'BTC', indexTokenAddress: addresses.BTC, link: 'https://app.gmx.io/#/stats'},
        ...
        "GM_NEAR_WETH_USDC": {name: "NEAR-WETH", symbol: "GM_NEAR_WETH_USDC", short: "GM", logoExt: 'png', price: 1, decimals: 18, address: addresses.GM_NEAR_WETH_USDC, debtCoverage: 0.83333333333, iconToken: 'NEAR', longToken: 'ETH', shortToken: 'USDC', indexTokenAddress: "0x1FF7F3EFBb9481Cbd7db4F932cBCD4467144237C", link: 'https://app.gmx.io/#/stats', addMethod: 'depositNearUsdcGmxV2', removeMethod: 'withdrawNearUsdcGmxV2'},
        "GM_ATOM_WETH_USDC": {name: "ATOM-WETH", symbol: "GM_ATOM_WETH_USDC", short: "GM", logoExt: 'svg', price: 1, decimals: 18, address: addresses.GM_ATOM_WETH_USDC, debtCoverage: 0.83333333333, iconToken: 'ATOM', longToken: 'ETH', shortToken: 'USDC', indexTokenAddress: "0x7D7F1765aCbaF847b9A1f7137FE8Ed4931FbfEbA", link: 'https://app.gmx.io/#/stats', addMethod: 'depositAtomUsdcGmxV2', removeMethod: 'withdrawAtomUsdcGmxV2'},
