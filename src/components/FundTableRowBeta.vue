  ...
  <div class="fund-table-row-component" :class="{'expanded': rowExpanded}">
    <div class="table__row">
      ...
      <div class="table__cell asset">
        <img class="asset__icon" src="src/assets/icons/avax-icon.svg">
        <div class="asset__info">
          <div class="asset__name">AVAX</div>
          <div class="asset__loan">Loan APY: {{ 0.0244 | percent }}</div>
        </div>
      </div>

      <div class="table__cell table__cell--double-value balance">
        <div class="double-value__pieces">112.32</div>
        <div class="double-value__usd">{{ 867.32 | usd }}</div>
      </div>

      <div class="table__cell table__cell--double-value loan">
        <div class="double-value__pieces">21.21</div>
        <div class="double-value__usd">{{ 675.21 | usd }}</div>
      </div>

      <div class="table__cell trend">
        <div class="trend__chart-change">
          <SmallChartBeta :data-points="mockedDataPoints" :line-width="2" :width="60" :height="25"></SmallChartBeta>
          <ColoredValueBeta :value="0.1521" :formatting="'percent'"></ColoredValueBeta>
        </div>
        <IconButtonMenuBeta
    ...
    <div class="chart-container" v-if="showChart">
      <SmallBlock v-on:close="toggleChart()">
        <Chart :data-points="mockedDataPoints" :line-width="3" :min-y="5" :max-y="10"></Chart>
      </SmallBlock>
    </div>
...
export default {
  ...
  components: {SmallBlock, Chart, IconButtonMenuBeta, PoolEventsList, ColoredValueBeta, SmallChartBeta},
  props: {
    asset: {}
  },
  mounted() {
