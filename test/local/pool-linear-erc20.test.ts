...
describe("Pool ERC20 token functions", () => {
  ...
  describe("transfer", () => {
    ...
    it("should accumulate user1 interest prior to transferring the funds", async () => {
      ...
      expect(await balanceOf(user1)).to.be.closeTo(0.0538, 0.000001);
    });
    ...
    it("should accumulate user2 interest prior to transferring the funds", async () => {
      ...
      // then
      expect(await balanceOf(user1)).to.be.closeTo(0.036666666, 0.000001);
      expect(await balanceOf(user2)).to.be.closeTo(3.2233333333, 0.000001);
    });
  ...
  describe("totalSupply with multiple depositors", () => {
    ...
    it("should properly sum total tokens supply with accumulated interest - minting", async () => {
      ...
      expect(balanceOfUser1).to.be.closeTo( 4.31980832, 0.000001);
      expect(balanceOfUser2).to.be.closeTo( 3.298375818, 0.000001);
      expect(balanceOfUser3).to.be.closeTo( 12.91686530, 0.000001);
      expect(balanceOfUser4).to.be.closeTo( 4.63262203, 0.000001);
      expect(balanceOfUser5).to.be.closeTo(  13.4488614, 0.000001);
    ...
    it("should properly sum total tokens supply with accumulated interest - burning", async () => {
      ...
      expect(await balanceOf(user1)).to.be.closeTo( 4.15471775, 0.000001);
      expect(await balanceOf(user2)).to.be.closeTo( 3.17232143, 0.000001);

      await sut.connect(user1).withdraw(toWei("2.06"));
      await sut.connect(user2).withdraw(toWei("1.1"));

      expect(await balanceOf(user1)).to.be.closeTo( 2.094717755, 0.000001);
      expect(await balanceOf(user2)).to.be.closeTo( 2.072321432, 0.000001);
    });
    ...
    it("should properly sum total tokens supply with accumulated interest - minting, burning and borrowing", async () => {
      ...
      expect(await balanceOf(user1)).to.be.closeTo( 3.1034423, 0.000001);
      expect(await balanceOf(user2)).to.be.closeTo( 2.12981339, 0.000001);
      await sut.connect(user1).withdraw(toWei("2.06"));
      await sut.connect(user2).withdraw(toWei("1.1"));

      expect(await balanceOf(user1)).to.be.closeTo( 1.04344237, 0.000001);
      expect(await balanceOf(user2)).to.be.closeTo( 1.02981339, 0.000001);
      ...
      expect(balanceOfUser1).to.be.closeTo( 1.1040046155, 0.000001);
      expect(balanceOfUser2).to.be.closeTo( 1.0895845982, 0.000001);
      ...
      //TODO: było 1.9107890715
      expect(balanceOfUser1).to.be.closeTo( 1.6970571938, 0.000001);
      //TODO: było 1.88566060
      expect(balanceOfUser2).to.be.closeTo( 1.674890987, 0.000001);
      ...
      //TODO: było 3.019594815
      expect(balanceOfUser1).to.be.closeTo( 2.360980823, 0.000001);
      //TODO: było 2.97988472
      expect(balanceOfUser2).to.be.closeTo( 2.330142741, 0.000001);
