...
describe("Pool ERC20 token functions", () => {
    ...
    describe("Initialize deposits", () => {
        ...
        it("should check initial deposit balances, initialize deposits, check balances again", async () => {
            expect(await balanceOf(user1)).to.be.closeTo(0, 0.000001);
            expect(await balanceOf(user2)).to.be.closeTo(0, 0.000001);
            expect(await balanceOf(user3)).to.be.closeTo(0, 0.000001);
            expect(await balanceOf(user4)).to.be.closeTo(0, 0.000001);
            expect(await balanceOf(user5)).to.be.closeTo(0, 0.000001);
            expect(await balanceOf(user6)).to.be.closeTo(0, 0.000001);
            expect(fromWei(await sut.totalSupply())).to.be.closeTo(0, 0.000001);
            ...
            expect(await balanceOf(user1)).to.be.closeTo(4.06, 0.000001);
            expect(await balanceOf(user2)).to.be.closeTo(3.1, 0.000001);
            expect(await balanceOf(user3)).to.be.closeTo(12.14, 0.000001);
            expect(await balanceOf(user4)).to.be.closeTo(4.354, 0.000001);
            expect(await balanceOf(user5)).to.be.closeTo(12.64, 0.000001);
            expect(await balanceOf(user6)).to.be.closeTo(20, 0.000001);
            expect(fromWei(await sut.totalSupply())).to.be.closeTo(56.294, 0.000001);
        });
