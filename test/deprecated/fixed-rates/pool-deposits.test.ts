...
import CompoundingIndexArtifact from '../../../artifacts/contracts/deprecated/CompoundingIndex.sol/CompoundingIndex.json';
...
import {Pool, OpenBorrowersRegistry, CompoundingIndex} from "../../../typechain";
