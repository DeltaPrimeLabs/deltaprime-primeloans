...
async function fetchData(maxTimestamp) {
    ...
    fs.writeFileSync('src/data/avalanche/GM_EPOCH_2.json', JSON.stringify(json))

    let collectedAvax = 0;

   let json1 = JSON.parse(fs.readFileSync('src/data/avalanche/GM_EPOCH_2.json'))
    ...
    fs.writeFileSync('src/data/avalanche/GM_EPOCH_2.json', JSON.stringify(json1))
...
function createDiffJson() {
    let json0 = JSON.parse(fs.readFileSync('src/data/avalanche/GM_EPOCH_1_fixed.json'))
    let json1 = JSON.parse(fs.readFileSync('src/data/avalanche/GM_EPOCH_2.json'))
    let json2 = {};
    ...
    fs.writeFileSync('src/data/avalanche/GM_EPOCH_2_diff.json', JSON.stringify(json2))
