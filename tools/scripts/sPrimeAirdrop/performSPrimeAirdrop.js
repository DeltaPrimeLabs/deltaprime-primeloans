...
async function performAirdrop(data) {
    ...
    // TODO: Set the correct total amount of AVAX and PRIME to be airdropped
    let totalAvaxAmount = 1234;
    let totalPrimeAmount = 1234;
    ...
    for(let i = 0; i < data.length; i++) {
        ...
        if(userBalance > 0) {
            ...
            try {
                ...
                let txHash = (await sPrimeContract.mintForUserAndLock(airdropAddress, percentForLocks, lockPeriods, primeInWei, avaxInWei)).hash;
